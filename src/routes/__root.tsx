...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Gulab Devi Teaching Hospital — Compassionate Care Since 1934" },
      { name: "description", content: "Gulab Devi Teaching Hospital, Lahore — 1,800+ beds, 42 specialised departments and 380+ expert doctors providing world-class, compassionate healthcare." },
