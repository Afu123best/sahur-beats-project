...
export const Route = createFileRoute("/departments/")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Explore 42+ specialised medical departments — from Cardiology to Oncology." },
...
function Departments() {
  ...
  return (
    <PublicLayout>
      <PageHeader breadcrumb="Care areas" title="Our Departments" subtitle="42 clinical specialties, one integrated hospital." />
      <section className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {filtered.map((d) => (
            <Link key={d.slug} to="/departments/$slug" params={{ slug: d.slug }} className="group rounded-2xl border bg-card p-6 transition-all hover:-translate-y-1 hover:border-primary/40 hover:shadow-elegant">
